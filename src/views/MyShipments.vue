  ...
  <ion-page>
    ...
    <ion-content>
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large">Mis Envios</ion-title>
        </ion-toolbar>
      </ion-header>
      <br><br>
          ...
          <table class="table table-responsive-sm table-striped table-align-middle">
            ...
            <tbody>
              ...
              <tr v-if="shipments?.data?.length == 0">
                <td colspan="3">Actualmente no se encuentra registros</td>
              </tr>
            </tbody>
          </table>
...
import { createAnimation ,IonSelect ,IonPage,IonButton, IonHeader,IonModal, IonToolbar,IonProgressBar, IonTitle, IonContent } from '@ionic/vue';
...
export default defineComponent({
  name: 'Tab2Page',
  components: {  IonHeader ,IonSelect,IonModal,IonButton, IonToolbar,IonProgressBar, IonTitle, IonContent, IonPage },
  ...
  methods: {
    ...
    getShipments(){
      axios.get('/api/shipments/my_shipments')
      .then(res => {
    ...
    getFilterShipments(){
      ...
      axios.post('/api/shipments/search/my_shipments',{
